...
def ParseArgs():
    ...
    parser.add_argument('--difflr', type=float, default=1e-5)
    ...
    parser.add_argument('--batch_size', default=1024, type=int, help='number of users in a testing batch') 
    ...
    parser.add_argument('--factor', type=float, default=0.00001, help='factor')
